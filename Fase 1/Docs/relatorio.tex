...
$D = (x,0,-z)$ \newline
\end{center}
Gerando o plano a partir do ponto C, e segundo o openGL, para a superfície do plano ficar visível do lado de fora pela regra da mão direita,
obtemos que os vértices dos triângulos $CAB$ e $CBD$, terão como coordenadas: \newline
\begin{center}
$CAB\rightarrow (-x,y,-z) (-x,y,z) (x,y,z) $ \newline
$CBD\rightarrow (-x,y,-z) (x,y,z) (x,y,-z)$ \newline
\end{center}
